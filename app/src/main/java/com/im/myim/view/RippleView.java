...
public class RippleView extends View {
    ...
    private void init() {
        ...
        mDensity = ConvertUtils.dp2px(mDensity);
    ...
    private void drawInCircle(Canvas canvas) {
        ...
        if (mRipples.size() > 0) {
            // 控制第二个圆出来的间距
            if (mRipples.get(mRipples.size() - 1).width > ConvertUtils.dp2px(mDensity)) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (myHeightSpecMode == MeasureSpec.EXACTLY) {
            ...
            // wrap_content
            mHeight = ConvertUtils.dp2px(120);
        }
